...
#ifndef SERVO_INTERFACES__MSG__DETAIL__INFERENCE_RESULT__TRAITS_HPP_
#define SERVO_INTERFACES__MSG__DETAIL__INFERENCE_RESULT__TRAITS_HPP_
...
inline void to_yaml(
  const servo_interfaces::msg::InferenceResult & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const servo_interfaces::msg::InferenceResult & msg)
{
  return servo_interfaces::msg::to_yaml(msg);
}

template<>
inline const char * data_type<servo_interfaces::msg::InferenceResult>()
{
  return "servo_interfaces::msg::InferenceResult";
}

template<>
inline const char * name<servo_interfaces::msg::InferenceResult>()
{
  return "servo_interfaces/msg/InferenceResult";
}

template<>
struct has_fixed_size<servo_interfaces::msg::InferenceResult>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<servo_interfaces::msg::InferenceResult>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<servo_interfaces::msg::InferenceResult>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // SERVO_INTERFACES__MSG__DETAIL__INFERENCE_RESULT__TRAITS_HPP_
