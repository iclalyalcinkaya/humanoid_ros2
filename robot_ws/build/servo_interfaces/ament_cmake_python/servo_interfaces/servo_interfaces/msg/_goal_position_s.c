...
bool servo_interfaces__msg__goal_position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("servo_interfaces.msg._goal_position.GoalPosition", full_classname_dest, 48) == 0);
  }
  servo_interfaces__msg__GoalPosition * ros_message = _ros_message;
  {  // x
...
PyObject * servo_interfaces__msg__goal_position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("servo_interfaces.msg._goal_position");
  ...
  {  // w
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->w);
    {
