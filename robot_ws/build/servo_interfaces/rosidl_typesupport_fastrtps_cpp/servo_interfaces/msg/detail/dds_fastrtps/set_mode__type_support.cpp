...
#include "servo_interfaces/msg/detail/set_mode__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const servo_interfaces::msg::SetMode & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  servo_interfaces::msg::SetMode & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = servo_interfaces::msg::SetMode;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const servo_interfaces::msg::SetMode *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<servo_interfaces::msg::SetMode *>(
    untyped_ros_message);
...
{
  return &servo_interfaces::msg::typesupport_fastrtps_cpp::_SetMode__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, servo_interfaces, msg, SetMode)() {
  return &servo_interfaces::msg::typesupport_fastrtps_cpp::_SetMode__handle;
}
