...
#include "servo_interfaces/msg/detail/inference_result__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = servo_interfaces::msg::InferenceResult;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const servo_interfaces::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<servo_interfaces::msg::InferenceResult *>(
    untyped_ros_message);
...
{
  return &servo_interfaces::msg::typesupport_fastrtps_cpp::_InferenceResult__handle;
}
