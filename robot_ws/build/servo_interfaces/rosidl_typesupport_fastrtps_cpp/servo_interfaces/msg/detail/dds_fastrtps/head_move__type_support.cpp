...
#include "servo_interfaces/msg/detail/head_move__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const servo_interfaces::msg::HeadMove & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  servo_interfaces::msg::HeadMove & ros_message)
{
  // Member: pan
  cdr >> ros_message.pan;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = servo_interfaces::msg::HeadMove;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_servo_interfaces
max_serialized_size_key_HeadMove(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const servo_interfaces::msg::HeadMove *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<servo_interfaces::msg::HeadMove *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _HeadMove__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const servo_interfaces::msg::HeadMove *>(
...
static size_t _HeadMove__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_HeadMove(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _HeadMove__callbacks = {
...
static rosidl_message_type_support_t _HeadMove__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_HeadMove__callbacks,
...
{
  return &servo_interfaces::msg::typesupport_fastrtps_cpp::_HeadMove__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, servo_interfaces, msg, HeadMove)() {
  return &servo_interfaces::msg::typesupport_fastrtps_cpp::_HeadMove__handle;
}
