...
#include "servo_interfaces/msg/detail/yolov8_inference__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const servo_interfaces::msg::InferenceResult &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  servo_interfaces::msg::InferenceResult &);
size_t get_serialized_size(
  const servo_interfaces::msg::InferenceResult &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const servo_interfaces::msg::Yolov8Inference & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: yolov8_inference
  {
    ...
    for (size_t i = 0; i < size; i++) {
      servo_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  servo_interfaces::msg::Yolov8Inference & ros_message)
{
  // Member: header
  ...
  // Member: yolov8_inference
  {
    ...
    for (size_t i = 0; i < size; i++) {
      servo_interfaces::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: yolov8_inference
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        servo_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: yolov8_inference
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        servo_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_InferenceResult(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = servo_interfaces::msg::Yolov8Inference;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: yolov8_inference
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; i++) {
      servo_interfaces::msg::typesupport_fastrtps_cpp::cdr_serialize_key(
        ros_message.yolov8_inference[i],
        cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: yolov8_inference
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        servo_interfaces::msg::typesupport_fastrtps_cpp::get_serialized_size_key(
        ros_message.yolov8_inference[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: yolov8_inference
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        servo_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_key_InferenceResult(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const servo_interfaces::msg::Yolov8Inference *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<servo_interfaces::msg::Yolov8Inference *>(
    untyped_ros_message);
...
{
  return &servo_interfaces::msg::typesupport_fastrtps_cpp::_Yolov8Inference__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, servo_interfaces, msg, Yolov8Inference)() {
  return &servo_interfaces::msg::typesupport_fastrtps_cpp::_Yolov8Inference__handle;
}
