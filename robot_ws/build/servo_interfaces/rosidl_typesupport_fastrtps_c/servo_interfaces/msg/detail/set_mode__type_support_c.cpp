...
#include "servo_interfaces/msg/detail/set_mode__rosidl_typesupport_fastrtps_c.h"
...
using _SetMode__ros_msg_type = servo_interfaces__msg__SetMode;


ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_servo_interfaces
bool cdr_serialize_servo_interfaces__msg__SetMode(
  const servo_interfaces__msg__SetMode * ros_message,
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_servo_interfaces
bool cdr_deserialize_servo_interfaces__msg__SetMode(
  eprosima::fastcdr::Cdr & cdr,
  servo_interfaces__msg__SetMode * ros_message)
{
  // Field name: mode
  {
    cdr >> ros_message->mode;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_servo_interfaces
size_t get_serialized_size_servo_interfaces__msg__SetMode(
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_servo_interfaces
size_t max_serialized_size_servo_interfaces__msg__SetMode(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = servo_interfaces__msg__SetMode;
    is_plain =
      (
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_servo_interfaces
bool cdr_serialize_key_servo_interfaces__msg__SetMode(
  const servo_interfaces__msg__SetMode * ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Field name: mode
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_servo_interfaces
size_t get_serialized_size_key_servo_interfaces__msg__SetMode(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetMode__ros_msg_type * ros_message = static_cast<const _SetMode__ros_msg_type *>(untyped_ros_message);
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_servo_interfaces
size_t max_serialized_size_key_servo_interfaces__msg__SetMode(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const servo_interfaces__msg__SetMode * ros_message = static_cast<const servo_interfaces__msg__SetMode *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_servo_interfaces__msg__SetMode(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  servo_interfaces__msg__SetMode * ros_message = static_cast<servo_interfaces__msg__SetMode *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_servo_interfaces__msg__SetMode(cdr, ros_message);
}

static uint32_t _SetMode__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_servo_interfaces__msg__SetMode(
...
static size_t _SetMode__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_servo_interfaces__msg__SetMode(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, servo_interfaces, msg, SetMode)() {
