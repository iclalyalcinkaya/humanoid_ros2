...
#include "servo_interfaces/msg/detail/inference_result__rosidl_typesupport_fastrtps_c.h"
...
using _InferenceResult__ros_msg_type = servo_interfaces__msg__InferenceResult;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = servo_interfaces__msg__InferenceResult;
    is_plain =
      (
      offsetof(DataType, id_n) +
      last_member_size
      ) == ret_val;
  }
  return ret_val;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const servo_interfaces__msg__InferenceResult * ros_message = static_cast<const servo_interfaces__msg__InferenceResult *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_servo_interfaces__msg__InferenceResult(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  servo_interfaces__msg__InferenceResult * ros_message = static_cast<servo_interfaces__msg__InferenceResult *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_servo_interfaces__msg__InferenceResult(cdr, ros_message);
}

static uint32_t _InferenceResult__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_servo_interfaces__msg__InferenceResult(
...
static size_t _InferenceResult__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_servo_interfaces__msg__InferenceResult(
