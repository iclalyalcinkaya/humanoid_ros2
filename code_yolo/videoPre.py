...
results = model.track(source='walking7.mp4',save=True, save_frames=True, conf=0.6, stream=True, persist=True, classes=[0], show_conf=False, show_labels=True)  # Tracking with default tracker
